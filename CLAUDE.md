This project is snaps, a Korean-first AI social content operations platform built on the existing scheduling core.
You can transform source content into platform-specific variants, add posts to the calendar, and publish them through workflow-backed scheduling.
...
- Team management
- Media library
- snaps 스튜디오 for Ollama content transformation, RAG style examples, reports, Pixelle shorts, and Korean SNS assist flows
