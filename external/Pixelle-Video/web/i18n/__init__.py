...
_current_language: str = "ko_KR"  # Snaps default language
...
def tr(key: str, fallback: Optional[str] = None, **kwargs) -> str:
    ...
    Example:
        ...
        tr("error.missing_field", field="API Key")  # => "??? API Key"
    """
...
def detect_system_language() -> str:
    ...
    Falls back to Korean for the Snaps build if no match is found.
    ...
    try:
        ...
        if system_locale:
            ...
            # Partial match (e.g., "ko" matches "ko_KR")
