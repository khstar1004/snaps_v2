        ...
        <div className="absolute left-0 w-full h-full pb-[20px]">
          <CopilotChat
            ...
            labels={{
              ...
              initial: t('agent_welcome_message', `Hello, I am your snaps agent.
              
I can schedule posts across channels, generate media, and help adapt source content into platform-specific drafts.
