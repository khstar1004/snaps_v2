  ...
  const firstMenu = [
    {
      ...
      icon: (
        ...
        >
          <path
            d="M6.2 3.2H14.4C16.72 3.2 18.6 5.08 18.6 7.4V15.6C18.6 17.92 16.72 19.8 14.4 19.8H6.2C4.65 19.8 3.4 18.55 3.4 17V8.4C3.4 5.53 5.73 3.2 8.6 3.2H15.8"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
          />
          <path
            d="M8 14.55C8.65 15.15 9.68 15.55 10.9 15.55C12.65 15.55 13.8 14.78 13.8 13.55C13.8 12.36 12.9 11.88 10.95 11.45C9.2 11.07 8.35 10.45 8.35 9.25C8.35 8.05 9.48 7.25 11.05 7.25C12.08 7.25 12.98 7.55 13.62 8.08"
            stroke="currentColor"
            strokeWidth="1.6"
            strokeLinecap="round"
          />
