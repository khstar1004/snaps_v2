...
export const OnboardingModal: FC<OnboardingModalProps> = ({ onClose }) => {
  ...
  return (
    <div className="w-full min-h-full flex-1 p-[40px] flex relative">
      ...
      <div className="flex flex-1 bg-newBgColorInner rounded-[8px] flex-col relative">
        <button
  ...
  return (
    <div className="flex flex-col gap-[24px]">
      ...
      <div className="flex justify-end pt-[24px] mt-[8px]">
        <button
          onClick={onNext}
          className="group flex items-center gap-[12px] bg-[#0EA5A8] hover:bg-[#0B8F95] text-white font-semibold px-[32px] py-[14px] rounded-[12px] text-[16px] transition-all"
        >
          {sortedIntegrations.length > 0
            ? t('continue', 'Continue')
...
const OnboardingStep2: FC<{ onBack: () => void; onFinish: () => void }> = ({
  ...
  return (
    <div className="flex flex-col gap-[24px] flex-1">
      <div className="flex gap-[4px] flex-col text-center">
        <div className="text-[24px] font-semibold">
          {t('watch_tutorial_title', 'Learn How to Use snaps')}
        </div>
        <div className="text-[14px] text-customColor18">
          {t(
            'watch_tutorial_description',
            'Watch this short video to learn how to get the most out of snaps'
          )}
        </div>
      </div>
      ...
      <div className="flex justify-between pt-[24px] mt-[8px]">
        ...
        <button
          onClick={onFinish}
          className="group flex items-center gap-[12px] bg-[#0EA5A8] hover:bg-[#0B8F95] text-white font-semibold px-[32px] py-[14px] rounded-[8px] text-[16px] transition-all"
        >
