    ...
    <div className="flex flex-col gap-[16px] pt-[8px]">
      <p className="text-[14px] text-textColor/80">
        {t(
          ...
          'The snaps browser extension is not installed. You need to install it before connecting this channel.'
        )}
      </p>
      <div className="flex gap-[10px]">
        <Button
          ...
          onClick={() => {
            window.open(
              process.env.NEXT_PUBLIC_SNAPS_EXTENSION_URL || '/settings',
              '_blank'
            );
            modals.closeCurrent();
          }}
  ...
  return (
    <div className="flex flex-col gap-[16px] pt-[8px]">
      ...
      <ul className="flex flex-col gap-[8px] list-disc ps-[20px] text-[14px] text-textColor/80">
        ...
        <li>
          snaps does not take responsibility for any issues arising or account
    ...
    (
      ...
      async () => {
        ...
        const gotoIntegration = async (externalUrl?: string) => {
          ...
          // carry the `snaps://` deep link so the backend redirects
          ...
          const params = [
            ...
            onboardingParam,
            isMobile
              ? `redirectUrl=${encodeURIComponent('snaps://integrations')}`
              : '',
          ]
            .filter(Boolean)
            .join('&');
          ...
          if (isMobile) {
            ...
            // app via `snaps://` once OAuth completes.
          ...
          try {
            ...
            toaster.show(
              t(
                ...
                'snaps browser extension is not installed or not reachable.'
              ),
              'warning'
            );
            return;
            ...
            .map((item) => (
              ...
              >
                <div>
                  ...
                  ) : item.identifier === 'naver-cafe' ? (
                    <img
                      className="w-[32px] h-[32px] rounded-full"
                      src="/icons/platforms/naver-cafe.svg"
                    />
                  ) : (
                    <img
                      className={clsx(
