export const testimonials1 = [
  ...
  },
  {
    ...
    content: (
      <>
        I just found out about snaps, a tool for Korean-first content
        operations.{' '}
        {'\n'}
        ...
        {'\n'}
        snaps seems to focus on turning one source into channel-ready posts.{' '}
        {'\n'}
        {'\n'}
      </>
    ),
  },
  {
    ...
    content: (
      <>
        As a privacy-first company we appreciate being able to self-host snaps!
        It brings the core functionality of a social media scheduler plus local
        AI workflows for transforming content faster. It's also very easy to
        deploy and use.
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        snaps changed how we manage our social media presence by aggregating
        our platforms into one effective tool. Platform-specific transformation,
        scheduling, and AI post ideation make our social media operations simple
  ...
  },
  {
    ...
    content: (
      <>
        ...
        n8n + snaps = Never miss a day of posting again: {'\n\n'}→ Easy to get
  ...
  },
  {
    ...
    content: (
      <>
        Manage all your social media accounts from a single place: snaps, a
...
export const testimonials2 = [
  {
    ...
    content: (
      <>
        Exciting news! I've just started using snaps, a focused new
        tool for scheduling my social media content! {'\n\n'}
        Why did I choose snaps? The ability to self-host it means significant
        savings for me! 💰 {'\n\n'}
        snaps is a self-hostable content operations tool that allows you to plan
        and automate posts across 19+ platforms, including X, LinkedIn, BlueSky,
        and Mastodon. {'\n\n'}
        ...
        scheduling! 📅✨ {'\n\n'}
        Built with privacy and flexibility in mind, snaps can run on your own
  ...
  },
  {
    ...
    content: (
      <>
        snaps makes it so easy to plan ahead. The AI suggestions are relevant,
