...
Start with the local `README.md` and `docs/snaps-completion-audit.md`. They describe the current snaps architecture, verification gates, and the remaining runtime checks. Read this document after those files so contribution scope stays aligned with the snaps fork.
...
- **Project discussion channel**: Use the repository discussion or the team's agreed chat workspace for quicker feedback.
...
2. **Clone your fork:** Bring a copy of your fork to your local machine.
   ```bash
   git clone https://github.com/YOUR_USERNAME/snaps.git
   ```
...
Again, check the local `README.md` and `docs/snaps-completion-audit.md`. Much of what you probably need to know is in there.

If you encounter any issues, open a repository issue with reproduction steps and environment details. Your contributions help make snaps better!
